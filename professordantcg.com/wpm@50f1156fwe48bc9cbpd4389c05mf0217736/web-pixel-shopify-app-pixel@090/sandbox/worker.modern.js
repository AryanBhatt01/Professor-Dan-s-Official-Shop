(() => {
    var e = {
            ...
            47: function(e, t, r) {
                ...
                ! function(n, o) {
                    ...
                    J.VERSION = "1.0.37", J.BROWSER = V([b, m, u]), J.CPU = V([w]), J.DEVICE = V([d, p, f, h, g, y, v, x, k]), J.ENGINE = J.OS = V([b, m]), typeof t !== s ? (e.exports && (t = e.exports = J), t.UAParser = J) : r.amdO ? (i = function() {
                        return J
    ...
    r.amdO = {}, r.n = e => {
        ...
        const p = "production",
            m = "0.0.475",
            w = "50f1156fwe48bc9cbpd4389c05mf0217736",
            h = "s50f1156fwe48bc9cbpd4389c05mf0217736m.js";
        var g = r(482),
            v = r.n(g);
        ...
        function M(e) {
            ...
            function({
                ...
                const r = j(t, e.browser.localStorage);
            ...
            function({
                ...
                const r = j(t, e.browser.sessionStorage);
        ...
        const _ = new URL(self.location.href);
        ...
        function D(e) {
            ...
            const r = _.host.replace(/[/\-\\^$*+?.()|[\]{}]/g, "\\$&");
            if (new RegExp(`^${_.protocol}//(.*@)?${r}`, "i").test(t.href)) throw new U(`Requests are not allowed to the same origin: ${t.href}`);
            return t
        }
        const F = Function.prototype.call.bind(XMLHttpRequest.prototype.open),
            W = ["constructor", "hasOwnProperty", "toString", "toLocaleString", "valueOf", "isPrototypeOf", "propertyIsEnumerable", "__defineGetter__", "__defineSetter__", "__lookupGetter__", "__lookupSetter__", "__proto__", "apply", "call", "bind"];

        function q(e, t) {
            if (Object.prototype.hasOwnProperty.call(e, t)) return e;
            const r = Object.getPrototypeOf(e);
            return r ? q(r, t) : void 0
        }
        ...
        function $(e, t, r) {
            try {
                ...
                if (Array.isArray(r)) {
                    const [i, o] = r;
                    "function" == typeof n && (n = e[t]), V(n, function(e) {
                        const t = new Set;
                        let r = e;
                        for (; r;) Object.getOwnPropertyNames(r).forEach((e => {
                            W.includes(e) || t.add(e)
        ...
        const J = async e => {
            ...
            if (Z) {
                ...
                throw O(e, {
                    ...
                    sandboxUrl: _.href || "unknown"
                }), e
            }
            Z = !0, a(o), a(s);
            try {
                Y && (o.browser.sendBeacon = E), Y || (M(e), self.document.title = r)
            } catch (l) {
                throw O(l, {
                    pixelId: i.id,
                    pixelType: i.type,
            ...
            return await (null == (t = K) ? void 0 : t.call(o, o)), {
                status: "success",
                hashVersion: w,
                sandboxUrl: _.href || "unknown"
            }
        ...
        ! function() {
            ...
            try {
                ...
                }(t.addEventListener)), V(t, r), Object.freeze(String.prototype), Object.freeze(Request.prototype), Object.freeze(URL.prototype), Object.freeze(RegExp.prototype), R(self, "String", {
                    writable: !1,
                    configurable: !1
                }), R(self, "Request", {
                    writable: !1,
...
importScripts('/wpm/strict/app/web-pixel-shopify-app-pixel@090.js');