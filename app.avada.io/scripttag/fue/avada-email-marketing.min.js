(() => {
            ...
            393: t => {
                var r = function(t) {
                    ...
                    function _(t, e) {
                        ...
                        if (n === r) {
                            if (e.delegate = null, "throw" === e.method) {
                                if (t.iterator.return && (e.method = "return", e.arg = r, _(t, e), "throw" === e.method)) return v;
                    ...
                    return g.prototype = L.constructor = m, m.constructor = g, g.displayName = u(m, c, "GeneratorFunction"), t.isGeneratorFunction = function(t) {
                        ...
                        return this
                    }, t.AsyncIterator = k, t.async = function(r, e, n, o, i) {
                        void 0 === i && (i = Promise);
                        var a = new k(h(r, e, n, o), i);
    ...
    e.n = t => {
        ...
        var t = e(528),
            ...
            c = e(777),
            u = e.n(c),
            h = "avada-session-email";
        console.log("%c AVADA Email Marketing has initialized ", "background: #054597; color: white"), (new function t() {
            var e = this;
            a()(this, t), u()(this, "initialize", o()(r().mark((function t() {
                return r().wrap((function(t) {
                    for (;;) switch (t.prev = t.next) {
                        case 0:
                            e.initEmailConversionTracking();
                        case 1:
                        case "end":
                            return t.stop()
                    }
                }), t)
            })))), u()(this, "initEmailConversionTracking", (function() {
                var t, r, e, n, o, i;
                "undefined" != typeof Shopify && void 0 !== Shopify.Checkout && void 0 !== Shopify.checkout && "thank_you" === Shopify.Checkout.page && ("number" == typeof(t = function(t) {
                    for (var r = t + "=", e = document.cookie.split(";"), n = 0; n < e.length; n++) {
                        for (var o = e[n];
                            " " == o.charAt(0);) o = o.substring(1, o.length);
                        if (0 == o.indexOf(r)) return o.substring(20, o.length)
                    }
                    return null
                }(h)) && (t = t.toString()), (null == t || "" === t.trim()) && (r = h, e = Shopify.checkout.email, n = 2592e5, o = "", (i = new Date).setTime(i.getTime() + n), o = "; expires=" + i.toUTCString(), document.cookie = r + "=" + (e || "") + o + "; path=/"))
            }))
        }).initialize()
    })()
})();