        ...
        if (cart_cell.length) {
            ...
            jQuery.each(cart, function(key, value) {
                if (key === 'items') {
                    ...
                    if (value.length) {
                        jQuery(".single-product-cart, .item-multiple-item-count,.cart-product-wrapper").css({
                            "display": "block"
                        });
                        jQuery(".single-cart-product.empty , .item-single-item-count").css({
                            "display": "none"
                        });
                        ...
                        jQuery(".single-product-cart, .item-single-item-count,.cart-product-wrapper").css({
                            "display": "none"
                        });
                        jQuery(".single-cart-product.empty").css({
                            "display": "block"
                        });
                    }
                }
